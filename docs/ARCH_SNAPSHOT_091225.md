...
└── Longevity Valley Brand Vision
    ...
    ├── docs
    │   ├── Opus 4.5
    │   │   ├── BRAND_FACTORY_GRAND_SCHEME.md
    │   │   ├── BRAND_FACTORY_GRAND_SCHEME(V2).md
    │   │   ├── CTO_REVIEW_SCORING_MATRIX.md
    │   │   ├── DIRECTOR_PERSONALITY_UX_FLOW.md
    │   │   ├── DIRECTOR_SOUL_GAP_ANALYSIS.md
    │   │   └── RASHOMON_MASTER_TRAINER_SCHEMA.md
    │   ├── .DS_Store
    ...
    │   ├── SECURITY.md
    │   ├── SESSION_CHANGELOG_081225.md
    │   ├── TECHNICAL_CHANGELOG_PHASE4.md
    │   ├── TEST_REPORT.md
    │   ├── TESTING_REAL_DATA_VALIDATION.md
    │   ├── TONE_VS_VOICE_LEARNING_CORRELATION.md
    │   ├── UX_EVALUATION_081225.md
    ...
    │   ├── sentinel.ts
    │   ├── test-anchor.ts
    │   ├── test-brain-transplant.ts
    │   ├── test-db-connection.ts
    │   ├── test-director-routing.ts
    ...
    │   │   └── 20251207_add_creative_profile_learning.sql
    │   ├── .DS_Store
    │   └── config.toml
    ├── .DS_Store
    ├── .env.example
...
```json
{
  ...
  "type": "module",
  "scripts": {
    "dev": "tsx scripts/sentinel.ts && next dev",
    "build": "tsx scripts/sentinel.ts && next build",
    "start": "next start",
    ...
    "ask:cto": "tsx scripts/consult-cto.ts",
    "prepare": "husky"
  },
  "dependencies": {
